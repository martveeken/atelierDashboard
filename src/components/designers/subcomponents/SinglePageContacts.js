    ...
    return (
      contacts.map(contact => (
        <div key={contact._id} className="extra content">
            ...
            <div>
              <Link to={{ pathname: '/designereditcontact/', state: { contact, id: _id } }} className="item">
                <button className="mini ui button" type="submit">Edit</button>
              </Link>
              <Link to={{ pathname: '/designerdeletecontact/', state: { contact, id: _id } }} className="item">
    ...
    <div className="column">
      <div className="ui card">
        ...
        <div className="extra content">
          <Link to={`/designeraddcontact/${props.designer._id}`} className="item">
